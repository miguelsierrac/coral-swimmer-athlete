...
>
	<div>
		...
		<div class="flex w-full grow bg-[#fcfaf8] @container p-4">
			<div
				class="size-full max-h-32 gap-1 overflow-hidden bg-[#fcfaf8] @[480px]:gap-2 aspect-[3/2] rounded-xl flex"
			>
				<div
					class="bg-center bg-no-repeat bg-cover aspect-auto rounded-none flex-1"
					style='background-image: url("https://cdn.usegalileo.ai/stability/c825eb13-b2bc-4ae8-98b8-c579de4e6a23.png");'
				></div>
			</div>
		</div>
		<div class="flex items-center gap-4 bg-[#fcfaf8] px-4 min-h-14">
