...
<div class="popover-content">
  ...
  {#if nextGrade}
    ...
    <p class="next-grade-criterion">
      <strong>Para lograrlo:</strong> {nextCriterion}
    </p>
  {:else}
    <div class="max-level-title">
      ¡Felicidades!
    </div>
  ...
  <div class="current-grades">
    <div class="grade-status" class:achieved={progress === 'bronce' || progress === 'plata' || progress === 'oro'}>
...
<style>
  ...
  .grade-bronce { background-color: #CD7F32; }
  .grade-plata { background-color: #C0C0C0; }
  .grade-oro { background-color: #FFD700; color: #333; }
